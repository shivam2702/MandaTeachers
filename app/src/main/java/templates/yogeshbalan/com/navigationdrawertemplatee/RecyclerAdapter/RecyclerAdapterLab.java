 ...
 */
public class RecyclerAdapterLab extends RecyclerView.Adapter<RecyclerAdapterLab.MyViewHolder> {
    final private Context context;
    List<labRecycler> data = Collections.emptyList();
    private LayoutInflater inflater;

    public RecyclerAdapterLab(Context context, List<labRecycler> data) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        String file = lab.file.get(position);
        String att = lab.att.get(position);
        String uni = lab.uni.get(position);
        String viva = lab.viva.get(position);
        String labb = lab.labb.get(position);
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(final View itemView) {
            ...
            attendancescore.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (attendancescore.isChecked()) {
                        lab.att.set(getPosition(), "1");
                        //Toast.makeText(context,"Position is Selected",Toast.LENGTH_SHORT).show();
                    } else {
                        lab.att.set(getPosition(), "0");
                        //Toast.makeText(context,"Position is Deselected",Toast.LENGTH_SHORT).show();
                    }
                }
            });
            labscore.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (labscore.isChecked()) {
                        lab.labb.set(getPosition(), "1");
                        //Toast.makeText(context,"Position is Selected",Toast.LENGTH_SHORT).show();
                    } else {
                        lab.labb.set(getPosition(), "0");
                        //Toast.makeText(context,"Position is Deselected",Toast.LENGTH_SHORT).show();
                    }
                }
            });
            uniformscore.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (uniformscore.isChecked()) {
                        lab.uni.set(getPosition(), "1");
                        //Toast.makeText(context,"Position is Selected",Toast.LENGTH_SHORT).show();
                    } else {
                        lab.uni.set(getPosition(), "0");
                        //Toast.makeText(context,"Position is Deselected",Toast.LENGTH_SHORT).show();
                    }
                }
            });
            zo.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    lab.viva.set(getPosition(), "0.00");
                }
            });
            tf.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    lab.viva.set(getPosition(), "0.25");
                }
            });
            fy.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    lab.viva.set(getPosition(), "0.50");
                }
            });
            sf.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    lab.viva.set(getPosition(), "0.75");
                }
            });
            one.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    lab.viva.set(getPosition(), "1.00");
                }
            });
