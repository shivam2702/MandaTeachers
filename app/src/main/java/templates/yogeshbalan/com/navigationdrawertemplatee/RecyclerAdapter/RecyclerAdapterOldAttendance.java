 ...
 */
public class RecyclerAdapterOldAttendance extends RecyclerView.Adapter<RecyclerAdapterOldAttendance.MyViewHolder> {
    List<attendanceRecycler> data = Collections.emptyList();

    private LayoutInflater inflater;
    private Context context;

    public RecyclerAdapterOldAttendance(Context context, List<attendanceRecycler> data) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        String assposs = BackDateAttendance.ATTENDANCE.get(position);
        if (assposs.equals("1")) {
    ...
    public int getItemCount() {
        return BackDateAttendance.STUDENTROLLNO.size();
        ...
        public MyViewHolder(final View itemView) {
            ...
            layout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(BackDateAttendance.ATTENDANCE.get(getPosition()).equals("1"))
                    {
                        BackDateAttendance.ATTENDANCE.set(getPosition(), "0");
                        attendance.setChecked(false);
                    }
                    else
                    {
                        BackDateAttendance.ATTENDANCE.set(getPosition(),"1");
